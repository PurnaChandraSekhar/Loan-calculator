...
function calculateResults() {
  // input variables
    ...
    let interestAmount = document.querySelector('#interest-amount');
    ...
    let calculatedInterest = parseFloat(interestAmount.value) / 100 / 12;
    let calculatedPayments = parseFloat(payment.value) * 12;
